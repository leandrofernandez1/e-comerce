...
function mensajeAgregadoExito() {
  document.querySelector("#mensajeExito").classList.remove("visually-hidden");
}

function mensajeAgregadoError() {
  document.querySelector("#mensajeError").classList.remove("visually-hidden");
}
  ...
  .then(datos => {
    ...
    document.querySelector("#comprar").addEventListener("click", () => {
      ...
      if (resultado == false) {
        ...
        mensajeAgregadoExito();
      } else if (resultado == true) {
        mensajeAgregadoError();
      };
